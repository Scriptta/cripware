...
local protect_gui = protect_gui or function(gui)
    rs.RenderStepped:Connect(function()
        gui.Name = genkey(math.random(5, 10))
    end)
end
...
function library:NewWindow(library_title, cfg_location)
    local menu = {}
    menu.values = {}
    ...
    function menu.SaveConfig(cfg_name)
    ...
    function menu.LoadConfig(cfg_name)
    ...
    library:MakeDraggable(ImageLabel)
    ...
    function menu.Tab(tab_image)
        ...
        function tab.Section(section_name)
            ...
            function section.Sector(sector_name, sector_side)
                local sector = {}
                ...
                function sector.CreateLine(thickness)
                ...
                function sector.CreateElement(type, text, data, callback, c_flag)
